...
const ITEMS: CommandItem[] = [
  { id: '1', label: 'Go to Dashboard', category: 'Navigation', action: () => console.log('→ Dashboard') },
  { id: '2', label: 'Go to Users', category: 'Navigation', action: () => console.log('→ Users') },
  { id: '3', label: 'Go to Settings', category: 'Navigation', action: () => console.log('→ Settings') },
  { id: '4', label: 'Create New User', category: 'Actions', action: () => console.log('Create user') },
  { id: '5', label: 'Export CSV', category: 'Actions', action: () => console.log('Export CSV') },
  { id: '6', label: 'Toggle Dark Mode', category: 'Preferences', action: () => console.log('Toggle theme') },
]
...
export default function CommandPalette() {
  ...
  return (
    <div className="space-y-4 rounded-lg border border-border p-6">
      <p className="text-sm text-muted-foreground">Press <kbd className="rounded border border-border px-1.5 py-0.5 text-xs font-mono">⌘K</kbd> or click the button to open.</p>
